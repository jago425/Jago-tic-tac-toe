...
var retrieveGames = function retrieveGames() {
  api.retrieveGame().then(ui.displayStats);
};
...
var updateGame = function updateGame(gameBoardCell, player, finished) {
  return $.ajax({
...
var retrieveGame = function retrieveGame(gameBoardCell, player, finished) {
  return $.ajax({
    url: config.apiOrigin + '/games',
    method: 'GET',
    headers: {
...
var checkWin = function checkWin(gameBoard) {
